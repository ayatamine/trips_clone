...
class SendPhoneData implements ShouldBroadcast
{
    ...
    public function broadcastWith(): array
    {
        return [
            ...
            'phone_provider'=>$this->data->phone_provider,
            'phone_number_2'=>$this->data->phone_number_2,
