                ...
                <div class="tab-pane fade show active" id="pills-booking" role="tabpanel"
                    ...
                    <div id="pills-tab" role="tablist" class="row nav nav-pills pd shadow-sm mb-3">
                        <div style="padding-left: unset;" class="row justify-content-center">
                            ...
                            <div class="col-4 nav-item" role="presentation">
                                <button class="nav-link w-100 border border-1 border-btn fs-nav" id="pills-global-tab"
                                    data-bs-toggle="pill" data-bs-target="#pills-global" type="button" role="tab"
                                    aria-controls="pills-global" aria-selected="false">رحلة
                                    دولية</button>
                            </div>
                        </div>
                    </div>
                            ...
                            <form method="post" action="{{route('init_trip','local')}}" class="p-1 row">
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        ...
                                        <select id="to" name="to" class="form-select cd" aria-label="الوصول" required>
                                ...
                                <div class="col-6 mb-2">
                                    <input type="radio" class="btn-check cd" value="one_direction" name="direction_type"
                                        id="one_direction" autocomplete="off" checked>
                                    <label class="btn btn-outline-secondary w-100 cd" for="one_direction">إتجاه
                                        واحد</label>
                                </div>
                                <div class="col-6 mb-2">
                                    <input type="radio" class="btn-check cd" value="go_and_back" name="direction_type"
                                        id="go_and_back" autocomplete="off" required>
                                    <label class="btn btn-outline-secondary w-100 cd" for="go_and_back">ذهاب
                                        وعودة</label>
                                </div>
                                <div class="col-6">
                                    <div class="mb-3">
                                        <label for="departure_date" class="form-label cd">تاريخ المغادرة</label>
                                        <input type="date" class="form-control cd" id="departure_date"
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="time" class="form-control cd" id="departure_time"
                                ...
                                <div class="col-3">
                                    <div class="mb-3">
                                        <select id="special_needs_count" name="special_needs_count"
                                            class="form-select cd" aria-label="الركاب ذوي الإحتياجات الخاصة" required>
                    ...
                    <form method="post" action="{{route('init_trip','bus')}}" class="p-1 row">
                            ...
                            <div class="mb-3">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="category" id="people"
                                        name="people" value="peoples" checked>
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control cd" id="serviceDate" name="serviceDate" required>
                                @error('serviceDate')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <input type="time" class="form-control cd" id="servicedeparture_time"
                                    name="servicedeparture_time" required>
                                @error('servicedeparture_time')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                <label for="city" class="form-label cd">مدينة الوصول</label>
                                <input type="text" class="form-control cd" id="city" name="city" required>
                                @error('city')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
